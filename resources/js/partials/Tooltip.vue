<template>
    ...
    >
        <div ref="triggerRef" class="inline-block cursor-help">
            <slot name="trigger">
        ...
        <transition name="graceful-fade">
            <div
                ...
                role="tooltip"
                :class="[
                    'absolute z-50 py-1 px-2 bg-gray-900 text-xs font-medium text-white rounded-md shadow-sm pointer-events-none whitespace-nowrap dark:bg-neutral-700',
                    positionClasses
                ]"
            >
                <slot name="content">
