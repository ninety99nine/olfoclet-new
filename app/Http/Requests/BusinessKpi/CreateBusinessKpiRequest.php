...
class CreateBusinessKpiRequest extends FormRequest
{
    /**
    ...
    {
        return $this->user()->can('create', [BusinessKpi::class, $this->route('app')]);
    }
    ...
    public function rules(): array
    {
        return [
            ...
            'metric_type' => ['required', 'string', Rule::in(['count', 'money', 'percentage', 'distribution'])],
            'chart_type' => ['required', 'string', Rule::in(['line', 'bar', 'doughnut'])],
