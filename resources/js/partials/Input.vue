            ...
            <div :class="[{ 'w-full' : copy }, 'space-y-2']">
                ...
                <div
                    ...
                    <label
                        ...
                        <template v-else>
                            ...
                            <span :style="labelStyle">{{ capitalize(label) }}</span>
                ...
                <div
                    ...
                    <IntlTelInput
                        ...
                        class="w-full h-full py-2 px-2.5 text-sm leading-6 font-medium text-gray-700 placeholder:text-gray-400 placeholder:font-normal focus-within:outline-none bg-transparent appearance-none [&::-webkit-search-cancel-button]:cursor-pointer"
                    />
